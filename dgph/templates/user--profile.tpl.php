...
<div class="row news-con">
    ...
    <div class=" nine columns myaccount">
        <?php
        ...
        <div id="accordion2">
            <h3>
                <div class="favoritetab">
                    <div class="favoritetabtitle">Favorite<span><?php echo $favsCount ?></span></div>
            ...
            <div>
                ...
                <div class="col-<?php echo $clsId ?> col">
                    <a title="Downlad" class="downlad" href="/catalogue/dataset/<?php echo $finfo['name'] ?>">View</a>
                ...
                ?>
                <div class="view-line"><a class="view-all" href="#">VIEW ALL</a></div>
            </div>
            <h3>
             	<div class="favoritetab">
